...
BOT_NAME = 'code3_scrap_links_its_info5'

SPIDER_MODULES = ['code3_scrap_links_its_info5.spiders']
NEWSPIDER_MODULE = 'code3_scrap_links_its_info5.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'code3_scrap_links_its_info5.proxymiddle.ProxyMiddleware': 100,
}
