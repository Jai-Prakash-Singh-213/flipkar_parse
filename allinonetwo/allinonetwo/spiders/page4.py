...
class DmozSpider(Spider):
    ...
    def parse(self, response):
        ...
        infodict["catname"] = [self.catname]

        infodict["brandname"] = [self.brandname]
	...
	if not sp:
            sp = spth("/html/body/div/div[2]/div/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/span/text()").extract()
	...
	if not sku:
            sku = spth("/html/body/div/div[2]/div/div/div[3]/div/div/div[3]/div[4]/div/div/a/@href").extract()
	...
	if not seller:
            seller = spth("/html/body/div/div[2]/div/div/div[3]/div/div/div[3]/div[2]/div[2]/div/div/a/text()").extract()
