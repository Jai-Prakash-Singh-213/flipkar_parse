...
BOT_NAME = 'code3_scrap_links_its_info4'

SPIDER_MODULES = ['code3_scrap_links_its_info4.spiders']
NEWSPIDER_MODULE = 'code3_scrap_links_its_info4.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'code3_scrap_links_its_info4.proxymiddle.ProxyMiddleware': 100,
}
